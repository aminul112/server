"""
Important Note:
This concept of asyncio code testing is used in Pycon 2019.I have copied this
file from https://github.com/nchazin/pycon2019/blob/master/addendum/loop_runner.py
